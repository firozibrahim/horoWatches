(function (global, factory) {
  ...
  class CropperSelection extends CropperElement__default["default"] {
      ...
      $propertyChangedCallback(name, oldValue, newValue) {
          ...
          switch (name) {
              case 'aspectRatio':
                  if (!utils.isPositiveNumber(newValue)) {
                      this.aspectRatio = NaN;
                  }
                  break;
      ...
      $handleAction(event) {
          ...
          if (currentTarget && detail) {
              ...
              if (!utils.isPositiveNumber(aspectRatio) && event.shiftKey) {
      ...
      $change(x, y, width = this.width, height = this.height, aspectRatio = this.aspectRatio) {
          if (!utils.isNumber(x) || !utils.isNumber(y) || !utils.isNumber(width) || !utils.isNumber(height)) {
              return this;
          }
          if (!this.precise) {
              x = Math.round(x);
